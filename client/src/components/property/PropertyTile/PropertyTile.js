    ...
    <div className='card col-4 mt-3 card-add-ons' key={props.id}>
      <div>
        <button
          ...
          onClick={() =>
            props.controlFavoritesList(props.id, props.isAuthenticated)
          }
        >
          <svg
            viewBox='0 0 32 32'
            ...
            role='presentation'
            focusable='false'
            className={`heart heart-${property.favorite ? "liked" : "empty"}`}
          >
      ...
      <div className='card-body'>
        <ul className='list-group list-group-flush'>
          ...
          <li className='list-group-item border-0 pt-0 pb-0 text-muted'>
            {property.distance}
          </li>
          <li className='list-group-item border-0 pt-0 pb-0 text-muted'>
